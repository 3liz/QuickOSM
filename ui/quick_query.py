...
class Ui_ui_quick_query(object):
    def setupUi(self, ui_quick_query):
        ...
        self.checkBox_node = QtWidgets.QCheckBox(self.groupBox)
        ...
        self.checkBox_way = QtWidgets.QCheckBox(self.groupBox)
        ...
        self.checkBox_relation = QtWidgets.QCheckBox(self.groupBox)
        ...
        self.spinBox_timeout = QtWidgets.QSpinBox(self.groupBox)
    ...
    def retranslateUi(self, ui_quick_query):
        ...
        self.groupBox.setTitle(_translate("ui_quick_query", "Advanced"))
        self.label_5.setText(_translate("ui_quick_query", "Timeout"))
        self.label_4.setText(_translate("ui_quick_query", "Directory"))
        self.lineEdit_browseDir.setPlaceholderText(_translate("ui_quick_query", "Save to temporary file"))
        self.pushButton_browse_output_file.setText(_translate("ui_quick_query", "Browse"))
