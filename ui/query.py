...
class Ui_ui_query(object):
    ...
    def retranslateUi(self, ui_query):
        ...
        self.lineEdit_browseDir.setPlaceholderText(_translate("ui_query", "Save to temporary file"))
        self.pushButton_browse_output_file.setText(_translate("ui_query", "Browse"))
