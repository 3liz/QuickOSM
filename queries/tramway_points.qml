...
<qgis version="2.4.0-Chugiak" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="railway" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="level_crossing" label="level_crossing"/>
      <category symbol="1" value="tram_stop" label="tram_stop"/>
    </categories>
    <symbols>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" name="tram"/>
