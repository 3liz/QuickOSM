...
<qgis version="2.4.0-Chugiak" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" name="name_oc"/>
    <edittype labelontop="0" editable="1" name="addr_postc"/>
    <edittype labelontop="0" editable="1" name="wikipedia"/>
    <edittype labelontop="0" editable="1" name="source_add"/>
    <edittype labelontop="0" editable="1" name="boundary"/>
    <edittype labelontop="0" editable="1" name="type"/>
    <edittype labelontop="0" editable="1" name="ref_INSEE"/>
    <edittype labelontop="0" editable="1" name="name_ko"/>
    <edittype labelontop="0" editable="1" name="name_ar"/>
    <edittype labelontop="0" editable="1" name="name_ru"/>
    <edittype labelontop="0" editable="1" name="name_ca"/>
    <edittype labelontop="0" editable="1" name="name_fa"/>
    <edittype labelontop="0" editable="1" name="name_frp"/>
    <edittype labelontop="0" editable="1" name="name_zh"/>
    <edittype labelontop="0" editable="1" name="website"/>
    <edittype labelontop="0" editable="1" name="name_ja"/>
    <edittype labelontop="0" editable="1" name="name_he"/>
    <edittype labelontop="0" editable="1" name="source_pop"/>
    <edittype labelontop="0" editable="1" name="name_la"/>
    <edittype labelontop="0" editable="1" name="name_uk"/>
    <edittype labelontop="0" editable="1" name="name_bg"/>
    <edittype labelontop="0" editable="1" name="name_sr"/>
    <edittype labelontop="0" editable="1" name="population"/>
    <edittype labelontop="0" editable="1" name="name_el"/>
  </edittypes>
  <editform></editform>
  ...
  <attributeactions>
    ...
    <actionsetting action="from QuickOSM.CoreQuickOSM.Actions import Actions;Actions.run(&quot;website&quot;,&quot;[% &quot;website&quot; %]&quot;)" capture="0" type="1" name="website"/>
    <actionsetting action="from QuickOSM.CoreQuickOSM.Actions import Actions;Actions.run(&quot;wikipedia&quot;,&quot;[% &quot;wikipedia&quot; %]&quot;)" capture="0" type="1" name="wikipedia"/>
  </attributeactions>
</qgis>
